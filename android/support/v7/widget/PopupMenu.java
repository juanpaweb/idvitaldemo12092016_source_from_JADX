...
public class PopupMenu {
    ...
    class C01922 implements android.widget.PopupWindow.OnDismissListener {
        C01922() {
        }
    ...
    class C03383 extends ForwardingListener {
        C03383(View src) {
            super(src);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0160R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03371());
        ...
        this.mPopup.setOnDismissListener(new C01922());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C03383(this.mAnchor);
        }
