...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00031 implements Comparator<View> {
        C00031() {
        }
    ...
    /* renamed from: android.support.design.widget.CoordinatorLayout.2 */
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mLayoutDependencyComparator = new C00031();
    ...
    void getDesiredAnchoredChildRect(View child, int layoutDirection, Rect anchorRect, Rect out) {
        ...
        int vgrav = absGravity & C0239R.styleable.AppCompatTheme_spinnerStyle;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & C0239R.styleable.AppCompatTheme_spinnerStyle;
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C02602();
                }
