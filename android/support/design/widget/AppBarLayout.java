...
public class AppBarLayout extends LinearLayout {
    ...
    class C02521 implements OnApplyWindowInsetsListener {
        C02521() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class C02531 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C02531(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            static class C02541 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02541() {
                }
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, int duration) {
            ...
            if (currentOffset != offset) {
                if (this.mOffsetAnimator == null) {
                    ...
                    this.mOffsetAnimator.setUpdateListener(new C02531(coordinatorLayout, child));
                } else {
                    this.mOffsetAnimator.cancel();
                }
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout header, int newOffset, int minOffset, int maxOffset) {
            ...
            if (minOffset == 0 || curOffset < minOffset || curOffset > maxOffset) {
                ...
                if (curOffset != newOffset) {
                    ...
                    updateAppBarLayoutDrawableState(appBarLayout, newOffset, newOffset < curOffset ? INVALID_POSITION : AppBarLayout.PENDING_ACTION_EXPANDED);
                }
            }
            return consumed;
        }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        a.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02521());
    }
