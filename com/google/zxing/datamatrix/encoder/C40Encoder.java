...
class C40Encoder implements Encoder {
    ...
    private static String encodeToCodewords(CharSequence sb, int startPos) {
        ...
        char cw1 = (char) (v / AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY);
        char cw2 = (char) (v % AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY);
