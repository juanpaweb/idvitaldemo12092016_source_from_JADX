...
public final class Detector {
    ...
    static {
        INDEXES_START_PATTERN = new int[]{0, 4, 1, ROW_STEP};
        INDEXES_STOP_PATTERN = new int[]{6, 2, 7, MAX_PIXEL_DRIFT};
        START_PATTERN = new int[]{8, 1, 1, 1, 1, 1, 1, MAX_PIXEL_DRIFT};
        STOP_PATTERN = new int[]{7, 1, 1, MAX_PIXEL_DRIFT, 1, 1, 1, 2, 1};
    }
