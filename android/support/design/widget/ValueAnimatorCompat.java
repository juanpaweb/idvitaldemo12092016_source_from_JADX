...
class ValueAnimatorCompat {
    ...
    class C02771 implements AnimatorUpdateListenerProxy {
        final /* synthetic */ AnimatorUpdateListener val$updateListener;

        C02771(AnimatorUpdateListener animatorUpdateListener) {
    ...
    class C02782 implements AnimatorListenerProxy {
        final /* synthetic */ AnimatorListener val$listener;

        C02782(AnimatorListener animatorListener) {
    ...
    public void setUpdateListener(AnimatorUpdateListener updateListener) {
        if (updateListener != null) {
            this.mImpl.setUpdateListener(new C02771(updateListener));
        } else {
    ...
    public void setListener(AnimatorListener listener) {
        if (listener != null) {
            this.mImpl.setListener(new C02782(listener));
        } else {
