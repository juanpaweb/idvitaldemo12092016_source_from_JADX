...
public final class CameraConfigurationUtils {
    ...
    static class C02251 implements Comparator<Size> {
        C02251() {
        }
    ...
    public static Point findBestPreviewSizeValue(Parameters parameters, Point screenResolution) {
        ...
        Collections.sort(arrayList, new C02251());
        if (Log.isLoggable(TAG, 4)) {
            StringBuilder previewSizesString = new StringBuilder();
            for (Size supportedPreviewSize : arrayList) {
                Size supportedPreviewSize2;
        ...
        while (it.hasNext()) {
            ...
            if (realWidth * realHeight < MIN_PREVIEW_PIXELS) {
                ...
                if (Math.abs((((double) maybeFlippedWidth) / ((double) maybeFlippedHeight)) - screenAspectRatio) > MAX_ASPECT_DISTORTION) {
                    ...
                    if (maybeFlippedWidth == r0) {
                        i = screenResolution.y;
                        if (maybeFlippedHeight == r0) {
