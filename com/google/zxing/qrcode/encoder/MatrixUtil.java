...
final class MatrixUtil {
    ...
    static {
        ...
        POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = new int[][]{new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, C0239R.styleable.AppCompatTheme_buttonStyle, -1, -1}, new int[]{6, 28, 54, 80, C0239R.styleable.AppCompatTheme_editTextStyle, -1, -1}, new int[]{6, 32, 58, 84, C0239R.styleable.AppCompatTheme_ratingBarStyleSmall, -1, -1}, new int[]{6, 30, 58, 86, C0239R.styleable.AppCompatTheme_listMenuViewStyle, -1, -1}, new int[]{6, 34, 62, 90, 118, -1, -1}, new int[]{6, 26, 50, 74, 98, 122, -1}, new int[]{6, 30, 54, 78, C0239R.styleable.AppCompatTheme_buttonStyle, TransportMediator.KEYCODE_MEDIA_PLAY, -1}, new int[]{6, 26, 52, 78, C0239R.styleable.AppCompatTheme_checkboxStyle, TransportMediator.KEYCODE_MEDIA_RECORD, -1}, new int[]{6, 30, 56, 82, C0239R.styleable.AppCompatTheme_ratingBarStyle, 134, -1}, new int[]{6, 34, 60, 86, C0239R.styleable.AppCompatTheme_spinnerStyle, 138, -1}, new int[]{6, 30, 58, 86, C0239R.styleable.AppCompatTheme_listMenuViewStyle, 142, -1}, new int[]{6, 34, 62, 90, 118, 146, -1}, new int[]{6, 30, 54, 78, C0239R.styleable.AppCompatTheme_buttonStyle, TransportMediator.KEYCODE_MEDIA_PLAY, 150}, new int[]{6, 24, 50, 76, C0239R.styleable.AppCompatTheme_buttonStyle, TransportMediator.FLAG_KEY_MEDIA_NEXT, 154}, new int[]{6, 28, 54, 80, C0239R.styleable.AppCompatTheme_editTextStyle, 132, 158}, new int[]{6, 32, 58, 84, C0239R.styleable.AppCompatTheme_ratingBarStyleSmall, 136, 162}, new int[]{6, 26, 54, 82, C0239R.styleable.AppCompatTheme_ratingBarStyleSmall, 138, 166}, new int[]{6, 30, 58, 86, C0239R.styleable.AppCompatTheme_listMenuViewStyle, 142, 170}};
