...
public class TextInputLayout extends LinearLayout {
    ...
    class C02754 implements AnimatorUpdateListener {
        C02754() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02761());
        }
    }
    ...
    class C03532 extends ViewPropertyAnimatorListenerAdapter {
        C03532() {
        }
    ...
    class C03543 extends ViewPropertyAnimatorListenerAdapter {
        final /* synthetic */ CharSequence val$error;

        C03543(CharSequence charSequence) {
        ...
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                try {
                    ...
                    this.mErrorView.setTextAppearance(getContext(), C0160R.style.TextAppearance_AppCompat_Caption);
    ...
    public void setError(@Nullable CharSequence error) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C03532()).start();
            } else {
                ViewCompat.setAlpha(this.mErrorView, 1.0f);
            }
        } else if (this.mErrorView.getVisibility() == 0) {
            if (animate) {
                ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new C03543(error)).start();
            } else {
                this.mErrorView.setText(error);
                this.mErrorView.setVisibility(4);
            }
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    this.mCounterView.setTextAppearance(getContext(), C0160R.style.TextAppearance_AppCompat_Caption);
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C02754());
            }
