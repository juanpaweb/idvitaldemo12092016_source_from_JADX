...
public final class Code39Reader extends OneDReader {
    ...
    static {
        ...
        CHARACTER_ENCODINGS = new int[]{52, 289, 97, 352, 49, 304, C0239R.styleable.AppCompatTheme_spinnerStyle, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, 193, 448, 145, 400, 208, 133, 388, 196, 148, 168, 162, 138, 42};
    ...
    public Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (nextStart == end || whiteSpaceAfterEnd * 2 >= lastPatternSize) {
            ...
            r23 = new ResultPoint[2];
            r23[0] = new ResultPoint(((float) (start[1] + start[0])) / 2.0f, (float) rowNumber);
            r23[1] = new ResultPoint(right, (float) rowNumber);
            return new Result(resultString, null, r23, BarcodeFormat.CODE_39);
        }
        throw NotFoundException.getNotFoundInstance();
    }
    ...
    private static String decodeExtended(CharSequence encoded) throws FormatException {
        ...
        while (i < length) {
            ...
            if (c == '+' || c == '$' || c == '%' || c == '/') {
                ...
                char decodedChar = '\u0000';
                switch (c) {
                    case C0239R.styleable.AppCompatTheme_actionModeShareDrawable /*36*/:
                        if (next >= 'A' && next <= 'Z') {
                        ...
                        break;
                    case C0239R.styleable.AppCompatTheme_actionModeFindDrawable /*37*/:
                        if (next < 'A' || next > 'E') {
                            if (next >= 'F' && next <= 'W') {
                        ...
                        break;
                        break;
                    case C0239R.styleable.AppCompatTheme_dialogTheme /*43*/:
                        if (next >= 'A' && next <= 'Z') {
                        ...
                        throw FormatException.getFormatInstance();
                        break;
                    case C0239R.styleable.AppCompatTheme_dropdownListPreferredItemHeight /*47*/:
                        if (next >= 'A' && next <= 'O') {
                            decodedChar = (char) (next - 32);
                            break;
                        } else if (next == 'Z') {
