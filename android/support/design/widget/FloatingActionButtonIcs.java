...
class FloatingActionButtonIcs extends FloatingActionButtonEclairMr1 {
    ...
    class C00041 extends AnimatorListenerAdapter {
        ...
        C00041(boolean z, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$fromUser = z;
    ...
    class C00052 extends AnimatorListenerAdapter {
        ...
        C00052(boolean z, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$fromUser = z;
            this.val$listener = internalVisibilityChangedListener;
        }
    ...
    void hide(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        if (this.mIsHiding || this.mView.getVisibility() != 0) {
            ...
            this.mView.animate().scaleX(0.0f).scaleY(0.0f).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new C00041(fromUser, listener));
        }
    }
    ...
    void show(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        ...
        this.mView.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00052(fromUser, listener));
    }
