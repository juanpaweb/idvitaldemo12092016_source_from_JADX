...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01341 implements AnimationListener {
        C01341() {
        }
    ...
    class C01352 extends Animation {
        C01352() {
        }
    ...
    class C01363 extends Animation {
        C01363() {
        }
    ...
    class C01374 extends Animation {
    ...
    class C01385 implements AnimationListener {
        C01385() {
        }
    ...
    class C01396 extends Animation {
        C01396() {
        }
    ...
    class C01407 extends Animation {
        C01407() {
        }
    ...
    class C01418 extends Animation {
        C01418() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01341();
        this.mAnimateToCorrectPosition = new C01396();
        this.mAnimateToStartPosition = new C01407();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01352();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01363();
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new C01374(startingAlpha, endingAlpha);
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01418();
