...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    class C03634 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C03634(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C03645 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C03645(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$animation = viewPropertyAnimatorCompat;
            super();
        }
    ...
    class C03656 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ int val$deltaX;
        final /* synthetic */ int val$deltaY;
        final /* synthetic */ ViewHolder val$holder;

        C03656(ViewHolder viewHolder, int i, int i2, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$deltaX = i;
            this.val$deltaY = i2;
            this.val$animation = viewPropertyAnimatorCompat;
    ...
    class C03667 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ ViewPropertyAnimatorCompat val$oldViewAnim;

        C03667(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C03678 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ View val$newView;
        final /* synthetic */ ViewPropertyAnimatorCompat val$newViewAnimation;

        C03678(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view) {
            this.val$changeInfo = changeInfo;
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                Runnable mover = new C01851(moves);
                if (removalsPending) {
            ...
            if (changesPending) {
                ...
                Runnable changer = new C01862(changes);
                if (removalsPending) {
            ...
            if (additionsPending) {
                ...
                Runnable adder = new C01873(additions);
    ...
    private void animateRemoveImpl(ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new C03634(holder, animation)).start();
    }
    ...
    private void animateAddImpl(ViewHolder holder) {
        ...
        animation.alpha(1.0f).setDuration(getAddDuration()).setListener(new C03645(holder, animation)).start();
    }
    ...
    private void animateMoveImpl(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new C03656(holder, deltaX, deltaY, animation)).start();
    }
    ...
    private void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new C03667(changeInfo, oldViewAnim)).start();
        }
        if (newView != null) {
            ViewPropertyAnimatorCompat newViewAnimation = ViewCompat.animate(newView);
            this.mChangeAnimations.add(changeInfo.newHolder);
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new C03678(changeInfo, newViewAnimation, newView)).start();
        }
    }
