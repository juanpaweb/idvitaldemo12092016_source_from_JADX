...
class SearchViewCompatHoneycomb {
    ...
    static class C01311 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01311(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01322 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01322(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
