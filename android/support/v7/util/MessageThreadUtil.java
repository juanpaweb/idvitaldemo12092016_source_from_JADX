...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C03271 implements MainThreadCallback<T> {
        ...
        class C01621 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C03271.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C03271.UPDATE_ITEM_COUNT /*1*/:
                            C03271.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C03271.ADD_TILE /*2*/:
                            C03271.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C03271.REMOVE_TILE /*3*/:
                            C03271.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C03271.this.mQueue.next();
                }
            }
        }

        C03271(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01621();
        }
    ...
    class C03282 implements BackgroundCallback<T> {
        ...
        class C01631 implements Runnable {
            ...
            public void run() {
                while (true) {
                    ...
                    if (msg != null) {
                        switch (msg.what) {
                            case C03282.REFRESH /*1*/:
                                C03282.this.mQueue.removeMessages(C03282.REFRESH);
                                C03282.this.val$callback.refresh(msg.arg1);
                                break;
                            case C03282.UPDATE_RANGE /*2*/:
                                C03282.this.mQueue.removeMessages(C03282.UPDATE_RANGE);
                                C03282.this.mQueue.removeMessages(C03282.LOAD_TILE);
                                C03282.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C03282.LOAD_TILE /*3*/:
                                C03282.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C03282.RECYCLE_TILE /*4*/:
                                C03282.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
        ...
        C03282(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01631();
        }
