...
class ViewCompatLollipop {
    ...
    static class C01071 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListenerBridge val$bridge;

        C01071(OnApplyWindowInsetsListenerBridge onApplyWindowInsetsListenerBridge) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListenerBridge bridge) {
        if (bridge == null) {
            ...
            view.setOnApplyWindowInsetsListener(new C01071(bridge));
        }
    }
