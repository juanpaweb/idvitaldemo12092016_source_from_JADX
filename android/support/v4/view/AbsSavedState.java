...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C03001 extends AbsSavedState {
        C03001() {
            super();
        }
    }
    ...
    static class C03012 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C03012() {
        }
    ...
    static {
        EMPTY_STATE = new C03001();
        CREATOR = ParcelableCompat.newCreator(new C03012());
    }
