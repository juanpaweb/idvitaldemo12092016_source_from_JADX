...
public class ViewPager extends ViewGroup {
    ...
    static class C01081 implements Comparator<ItemInfo> {
        C01081() {
        }
    ...
    static class C01092 implements Interpolator {
        C01092() {
        }
    ...
    class C03064 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01081();
        sInterpolator = new C01092();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01103();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03064());
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0239R.styleable.AppCompatTheme_spinnerStyle;
