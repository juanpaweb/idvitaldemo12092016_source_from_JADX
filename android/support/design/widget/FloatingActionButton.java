...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    class C02621 implements InternalVisibilityChangedListener {
        final /* synthetic */ OnVisibilityChangedListener val$listener;

        C02621(OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        class C02631 implements AnimatorUpdateListener {
            ...
            C02631(FloatingActionButton floatingActionButton) {
        ...
        private void updateFabTranslationForSnackbar(CoordinatorLayout parent, FloatingActionButton fab, boolean animationAllowed) {
            ...
            if (this.mFabTranslationY != targetTransY) {
                ...
                if (animationAllowed && fab.isShown() && Math.abs(currentTransY - targetTransY) > ((float) fab.getHeight()) * 0.667f) {
                    if (this.mFabTranslationYAnimator == null) {
                        ...
                        this.mFabTranslationYAnimator.setUpdateListener(new C02631(fab));
                    }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mBackgroundTintMode = parseTintMode(a.getInt(C0000R.styleable.FloatingActionButton_backgroundTintMode, SIZE_AUTO), null);
