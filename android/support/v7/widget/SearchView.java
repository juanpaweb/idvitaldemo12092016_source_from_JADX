...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02004 implements OnFocusChangeListener {
        C02004() {
        }
    ...
    class C02015 implements OnLayoutChangeListener {
        C02015() {
        }
    ...
    class C02026 implements OnGlobalLayoutListener {
        C02026() {
        }
    ...
    class C02037 implements OnClickListener {
        C02037() {
        }
    ...
    class C02048 implements OnKeyListener {
        C02048() {
        }
    ...
    class C02059 implements OnEditorActionListener {
        C02059() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0160R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0160R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01971();
        this.mUpdateDrawableStateRunnable = new C01982();
        this.mReleaseCursorRunnable = new C01993();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02037();
        this.mTextKeyListener = new C02048();
        this.mOnEditorActionListener = new C02059();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0160R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0160R.styleable.SearchView_layout, C0160R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0160R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0160R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0160R.id.search_plate);
        this.mSubmitArea = findViewById(C0160R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0160R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0160R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0160R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0160R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0160R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0160R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0160R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0160R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0160R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0160R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0160R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0160R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0160R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0160R.styleable.SearchView_suggestionRowLayout, C0160R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0160R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02004());
        setIconifiedByDefault(a.getBoolean(C0160R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0160R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0160R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0160R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0160R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0160R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0160R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C02015());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02026());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0160R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0160R.dimen.abc_search_view_preferred_height);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0160R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0160R.dimen.abc_dropdownitem_text_padding_left) : 0;
