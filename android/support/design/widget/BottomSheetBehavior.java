...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static class C02561 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02561() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02561());
        }
    }

    public BottomSheetBehavior() {
        this.mState = STATE_COLLAPSED;
        this.mDragCallback = new C02551();
    }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        setPeekHeight(a.getDimensionPixelSize(C0000R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, 0));
