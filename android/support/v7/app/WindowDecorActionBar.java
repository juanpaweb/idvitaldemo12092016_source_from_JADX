...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C03243 implements ViewPropertyAnimatorUpdateListener {
        C03243() {
        }
    ...
    class C03602 extends ViewPropertyAnimatorListenerAdapter {
        C03602() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C03591();
        this.mShowListener = new C03602();
        this.mUpdateListener = new C03243();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0160R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0160R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0160R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0160R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0160R.styleable.ActionBar, C0160R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0160R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0160R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0160R.attr.actionBarWidgetTheme, outValue, true);
