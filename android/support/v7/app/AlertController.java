...
class AlertController {
    ...
    class C01474 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01474(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C01491 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            C01491(Context x0, int x1, int x2, CharSequence[] x3, ListView listView) {
        ...
        class C01502 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01502(Context x0, Cursor x1, boolean x2, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class C01513 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C01513(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C01524 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01524(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C01491(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c01502 = new C01502(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C01513(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C01524(listView, dialog));
            }
    ...
    class C03182 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C03182(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0160R.styleable.AlertDialog, C0160R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0160R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0160R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0160R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0160R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0160R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0160R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0160R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0160R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0160R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0160R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0160R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0160R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0160R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0160R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0160R.id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0160R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0160R.id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C03182(top, bottom));
                this.mScrollView.post(new C01463(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C01474(top, bottom));
                this.mListView.post(new C01485(top, bottom));
            } else {
                if (top != null) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0160R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0160R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0160R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0160R.id.scrollView);
