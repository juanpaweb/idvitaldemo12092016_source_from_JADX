...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C00262 implements OnPreDrawListener {
        ...
        C00262(View view, Object obj, ArrayList arrayList, TransitionState transitionState, Object obj2, Object obj3, boolean z, Fragment fragment, Fragment fragment2) {
    ...
    class C02821 implements ViewRetriever {
        final /* synthetic */ Fragment val$inFragment;

        C02821(Fragment fragment) {
            this.val$inFragment = fragment;
        }
    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        ViewRetriever c02821 = new C02821(inFragment);
        ...
        if (transition != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, sharedElementTransition, exitTransition, sceneRoot, c02821, state.nonExistentView, state.enteringEpicenterView, state.nameOverrides, enteringViews, exitingViews, namedViews, renamedViews, sharedElementTargets);
    ...
    private void prepareSharedElementTransition(TransitionState state, View sceneRoot, Object sharedElementTransition, Fragment inFragment, Fragment outFragment, boolean isBack, ArrayList<View> sharedElementTargets, Object enterTransition, Object exitTransition) {
        if (sharedElementTransition != null) {
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00262(sceneRoot, sharedElementTransition, sharedElementTargets, state, enterTransition, exitTransition, isBack, inFragment, outFragment));
        }
    }
