...
class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case C0239R.styleable.AppCompatTheme_imageButtonStyle /*65*/:
                case C0239R.styleable.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                    incr = 7;
                    break;
                case C0239R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                case C0239R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle /*99*/:
                    incr = 6;
                    break;
                case C0239R.styleable.AppCompatTheme_listPreferredItemHeightLarge /*72*/:
                case C0239R.styleable.AppCompatTheme_colorControlNormal /*86*/:
                case C0239R.styleable.AppCompatTheme_checkboxStyle /*104*/:
                case 'v':
                    incr = 1;
                    break;
                ...
                case 't':
                    incr = 2;
                    break;
                case C0239R.styleable.AppCompatTheme_panelMenuListTheme /*81*/:
                case C0239R.styleable.AppCompatTheme_colorPrimary /*83*/:
                case C0239R.styleable.AppCompatTheme_switchStyle /*113*/:
                case 's':
                    incr = 4;
                    break;
        ...
        for (currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case C0239R.styleable.AppCompatTheme_dialogPreferredPadding /*44*/:
                    foundSeparator = true;
                    break;
                case C0239R.styleable.AppCompatTheme_listDividerAlertDialog /*45*/:
                ...
                case C0239R.styleable.AppCompatTheme_autoCompleteTextViewStyle /*101*/:
                    isExponential = true;
                    break;
            }
            if (foundSeparator) {
