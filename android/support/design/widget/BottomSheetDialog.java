...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C02572 extends BottomSheetCallback {
        C02572() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C02572();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        if (shouldWindowCloseOnTouchOutside()) {
            coordinator.findViewById(C0000R.id.touch_outside).setOnClickListener(new C00021());
        }
        return coordinator;
    }
