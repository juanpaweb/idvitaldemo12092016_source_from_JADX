...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C03151 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListener val$listener;

            C03151(OnQueryTextListener onQueryTextListener) {
        ...
        class C03162 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListener val$listener;

            C03162(OnCloseListener onCloseListener) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListener listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C03151(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListener listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C03162(listener));
        }
