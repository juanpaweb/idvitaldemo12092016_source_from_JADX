...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C02741 implements AnimatorUpdateListener {
            ...
            C02741(int i, int i2, int i3, int i4) {
        ...
        class C03522 extends AnimatorListenerAdapter {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setUpdateListener(new C02741(startLeft, targetLeft, startRight, targetRight));
                animator.setListener(new C03522(position));
                animator.start();
            }
        }
    ...
    class C02731 implements AnimatorUpdateListener {
        C02731() {
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0160R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0160R.styleable.TextAppearance_android_textSize, MODE_SCROLLABLE);
            this.mTabTextColors = ta.getColorStateList(C0160R.styleable.TextAppearance_android_textColor);
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C02731());
                }
