...
public class AsyncListUtil<T> {
    ...
    class C03251 implements MainThreadCallback<T> {
        C03251() {
        }
    ...
    class C03262 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C03251();
        this.mBackgroundCallback = new C03262();
        this.mTClass = klass;
