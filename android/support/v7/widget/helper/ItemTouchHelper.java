...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C02154 implements Runnable {
        ...
        C02154(RecoverAnimation recoverAnimation, int i) {
    ...
    public static abstract class Callback {
        ...
        static {
            sDragScrollInterpolator = new C02161();
            sDragViewScrollCapInterpolator = new C02172();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0161R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    class C03472 implements OnItemTouchListener {
        C03472() {
        }
    ...
    class C03485 implements ChildDrawingOrderCallback {
        C03485() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C03491 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C03491(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C03491(ItemTouchHelper.this));
    ...
    class C03713 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C03713(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY, int i, ViewHolder viewHolder2) {
            this.val$swipeDir = i;
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0161R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0161R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    RecoverAnimation rv = new C03713(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY, swipeDir, prevSelected);
    ...
    private void postDispatchSwipe(RecoverAnimation anim, int swipeDir) {
        this.mRecyclerView.post(new C02154(anim, swipeDir));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03485();
            }
