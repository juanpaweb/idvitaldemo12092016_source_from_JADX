...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class C01531 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        C01531(UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null, new int[]{C0160R.attr.homeAsUpIndicator});
    ...
    static {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new C01531(Thread.getDefaultUncaughtExceptionHandler()));
