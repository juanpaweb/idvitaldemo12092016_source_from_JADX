...
final class DecodedBitStreamParser {
    ...
    static /* synthetic */ class C02311 {
        static final /* synthetic */ int[] f8x45bba1d;

        static {
            f8x45bba1d = new int[Mode.values().length];
            try {
                f8x45bba1d[Mode.ALPHA.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f8x45bba1d[Mode.LOWER.ordinal()] = DecodedBitStreamParser.NUMBER_OF_SEQUENCE_CODEWORDS;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f8x45bba1d[Mode.MIXED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f8x45bba1d[Mode.PUNCT.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f8x45bba1d[Mode.ALPHA_SHIFT.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f8x45bba1d[Mode.PUNCT_SHIFT.ordinal()] = 6;
        ...
        while (codeIndex2 < codewords[0]) {
            switch (code) {
                ...
                case ECI_GENERAL_PURPOSE /*926*/:
                    codeIndex2 += NUMBER_OF_SEQUENCE_CODEWORDS;
                    break;
    ...
    private static void decodeTextCompaction(int[] textCompactionData, int[] byteCompactionData, int length, StringBuilder result) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            char ch = '\u0000';
            switch (C02311.f8x45bba1d[subMode.ordinal()]) {
