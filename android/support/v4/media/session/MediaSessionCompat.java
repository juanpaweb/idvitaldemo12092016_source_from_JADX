...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0239R.styleable.AppCompatTheme_panelBackground /*79*/:
                        case C0239R.styleable.AppCompatTheme_colorAccent /*85*/:
                            boolean isPlaying;
                        ...
                        case C0239R.styleable.AppCompatTheme_colorButtonNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                            }
        ...
        class C02961 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02961() {
            }
        ...
        class C03552 implements Callback {
            C03552() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent) {
            ...
            this.mVolumeCallback = new C02961();
