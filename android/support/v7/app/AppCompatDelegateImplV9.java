...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01551 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0) {
                AppCompatDelegateImplV9.this.doInvalidatePanelMenu(C0239R.styleable.AppCompatTheme_ratingBarStyle);
            }
    ...
    class C01565 implements Runnable {
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C03221 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C03221() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C03221());
            }
        }
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0160R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0160R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0160R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0160R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0160R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0160R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0160R.layout.abc_list_menu_item_layout);
    ...
    class C03192 implements OnApplyWindowInsetsListener {
        C03192() {
        }
    ...
    class C03203 implements OnFitSystemWindowsListener {
        C03203() {
        }
    ...
    class C03214 implements OnAttachListener {
        C03214() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0239R.styleable.AppCompatTheme_ratingBarStyle, subMenu);
            }
            return true;
        }
    ...
    class C03576 extends ViewPropertyAnimatorListenerAdapter {
        C03576() {
        }
    ...
    AppCompatDelegateImplV9(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C01551();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0239R.styleable.AppCompatTheme_ratingBarStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0160R.styleable.AppCompatTheme);
        if (a.hasValue(C0160R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(C0160R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0160R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(C0239R.styleable.AppCompatTheme_ratingBarStyle);
            }
            if (a.getBoolean(C0160R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0239R.styleable.AppCompatTheme_ratingBarStyleIndicator);
            }
            if (a.getBoolean(C0160R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0160R.styleable.AppCompatTheme_android_windowIsFloating, false);
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(C0160R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(C0160R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C03192());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C03203());
                }
            } else if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0160R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context themedContext;
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0160R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    themedContext = this.mContext;
                }
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0160R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0160R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0239R.styleable.AppCompatTheme_ratingBarStyleIndicator);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0160R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0160R.id.action_bar_activity_content);
            ...
            contentView.setAttachListener(new C03214());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0160R.styleable.AppCompatTheme);
        a.getValue(C0160R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0160R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0160R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0160R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0160R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0160R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0160R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0160R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0160R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0160R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0239R.styleable.AppCompatTheme_ratingBarStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case C0239R.styleable.Toolbar_contentInsetEndWithActions /*10*/:
                ...
                return true;
            case C0239R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0239R.styleable.AppCompatTheme_ratingBarStyleIndicator /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0239R.styleable.AppCompatTheme_ratingBarStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0160R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, null, C0160R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0160R.attr.actionBarSize, outValue, true);
                    ...
                    this.mShowActionModePopup = new C01565();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0160R.id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C03576());
                    } else {
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case ItemTouchHelper.LEFT /*4*/:
                ...
                break;
            case C0239R.styleable.AppCompatTheme_listChoiceBackgroundIndicator /*82*/:
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0239R.styleable.AppCompatTheme_ratingBarStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0239R.styleable.AppCompatTheme_ratingBarStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0239R.styleable.AppCompatTheme_ratingBarStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.applyStyle(outValue.resourceId, true);
                widgetTheme.resolveAttribute(C0160R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0160R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0239R.styleable.AppCompatTheme_ratingBarStyle) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0239R.styleable.AppCompatTheme_ratingBarStyle, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0239R.styleable.AppCompatTheme_ratingBarStyle || featureId == 0) && this.mDecorContentParent != null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0160R.color.abc_input_method_navigation_guard));
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0239R.styleable.AppCompatTheme_ratingBarStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0239R.styleable.AppCompatTheme_ratingBarStyleIndicator;
        }
    }
