...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C03621 extends ViewPropertyAnimatorListenerAdapter {
        C03621() {
        }
    ...
    static {
        ATTRS = new int[]{C0160R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03621();
        this.mRemoveActionBarHideOffset = new C01702();
        this.mAddActionBarHideOffset = new C01713();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0160R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0160R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0160R.id.action_bar));
        }
    }
