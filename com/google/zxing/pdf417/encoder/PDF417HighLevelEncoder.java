...
final class PDF417HighLevelEncoder {
    ...
    static {
        ...
        MIXED = new byte[TransportMediator.FLAG_KEY_MEDIA_NEXT];
        PUNCTUATION = new byte[TransportMediator.FLAG_KEY_MEDIA_NEXT];
            ...
            while (p < len) {
                ...
                if (n >= 13) {
                    ...
                    if (t >= 5 || n == len) {
                        ...
                        if (bytes.length == SUBMODE_LOWER && encodingMode == 0) {
                            encodeBinary(bytes, SUBMODE_ALPHA, SUBMODE_LOWER, SUBMODE_ALPHA, sb);
                        } else {
                            encodeBinary(bytes, SUBMODE_ALPHA, bytes.length, encodingMode, sb);
