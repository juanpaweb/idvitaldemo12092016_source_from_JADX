...
class AccessibilityManagerCompatKitKat {
    ...
    static class C01161 implements TouchExplorationStateChangeListener {
        final /* synthetic */ TouchExplorationStateChangeListenerBridge val$bridge;

        C01161(TouchExplorationStateChangeListenerBridge touchExplorationStateChangeListenerBridge) {
